...
export default function AdminDashboardPage() {
    const productsQuery = useQuery<{totalProducts: number}>("analytics/total-products"),
        ticketsQuery = useQuery<{totalTickets: number}>("analytics/total-tickets"),
        revenueQuery = useQuery<{totalRevenue: number}>("analytics/revenue"),
        roomsOccupancyQuery = useQuery<RoomOccupancy[]>("analytics/rooms/occupancy")
                ...
                <div className="w-full flex flex-col gap-7">
                    {
                        roomsOccupancyQuery.data?.reduce((acc, curr) => {
                            ...
                            const index = acc.findIndex(branch => branch.branch === curr.branch)
                            ...
                            <div key={branch.branch} className="w-full h-fit flex flex-col gap-5">
